            ...
            <div class="lg:col-span-2 bg-white rounded-lg shadow p-6">
                ...
                <div class="status-stepper">
                    ...
                    <div class="status-step" data-step="order placed">
                        ...
                        <div class="status-time" id="time-order-placed"><?= $dataPesanan[0]['waktu_approve_formatted'] ?? '10:30 AM' ?></div>
                    </div>
                ...
                <div class="mt-8 border-t pt-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            <!-- Diubah dari Shipping To menjadi Shipping From -->
                            <p class="font-semibold text-gray-700">Shipping From</p>
                            
                            <div class="supplier-info">
                                <div class="supplier-icon">
                                    <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6 text-[#A2845E]" fill="none" viewBox="0 0 24 24" stroke="currentColor">
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            function updateOrderDetail(data) {
                ...
                // Set waktu untuk status 'order placed'
