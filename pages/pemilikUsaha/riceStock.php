            ...
            <div class="mt-6 overflow-x-auto">
                <table class="w-full">
                        ...
                        <tr class="<?= $index % 2 === 0 ? 'bg-[#FFEEDB]' : 'bg-[#E7DDD3]' ?> hover:bg-[#D1BEAB]">
                            ...
                            <td class="px-4 py-3 text-center">
                                <div class="inline-flex space-x-3 justify-center">
                                    <a href="detailProduct.php?id=<?= $beras['idBeras'] ?>&action=view"
                 ...
                 7-9.542 7-4.477 0-8.268-2.943-9.542-7z" />
                                    ...
                                    <a href="editProduct.php?id=<?= $beras['idBeras'] ?>"
                                    ...
                                    <button
                                        onclick="if(confirm('Yakin mau dihapus?')){ window.location='deleteProduct.php?id=<?= $beras['idBeras'] ?>'; }"
