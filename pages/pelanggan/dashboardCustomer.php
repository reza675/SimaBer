...
<body class="bg-[#EFE9E2] min-h-screen flex flex-col">
    ...
    <main class="flex-grow overflow-auto min-h-0">
        <div class="main-container ">
                ...
                <div class="relative inline-block text-left">
                    ...
                    <div id="dropdownProfile"
                        ...
                        <a href="settingsCustomer.php"
                            class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 font-semibold text-center">Settings</a>
            ...
            <div class="bg-[#A2845E] py-10">
                ...
                <p class="font-reguler text-lg text-[#CECCCC] text-center">We’re committed to bringing you premium rice
                    at
            ...
            <div class="mt-4 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6 px-4 sm:px-8 lg:px-16">
            ...
            <div
                class="mt-4 mb-12 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 px-4 sm:px-8 lg:px-16 auto-rows-[200px]">
                <div
                    class="relative sm:row-span-2 rounded-lg overflow-hidden transition duration-300 ease-in-out hover:scale-105 hover:shadow-lg">
            ...
            <div class="bg-[#A2845E] pt-6 mt-6 mb-6">
                <div class="px-4 sm:px-8 lg:px-16 py-6 flex flex-col lg:flex-row lg:items-start gap-8 lg:gap-16">

                    <div class="flex-shrink-0 space-y-4 text-center lg:text-left">
                        <h2 class="text-2xl sm:text-3xl font-semibold text-white">Why Choose SimaBer?</h2>
                        <a href="orderCustomer.php"
                            class="inline-flex items-center bg-black text-white font-semibold py-2 px-4 sm:py-3 sm:px-6 rounded-full hover:bg-gray-800 transition">
                            Get Started
                            <svg class="ml-2" width="10" height="12" viewBox="0 0 10 16" fill="none"
                                xmlns="http://www.w3.org/2000/svg">
                                <path fill-rule="evenodd" clip-rule="evenodd"
                        ...
                        <img src="../../assets/gambar/pelanggan/Dashboard1_pelanggan.png" alt="Thinking Person"
                            class="mx-auto lg:mx-0 w-32 h-32 sm:w-40 sm:h-40" />
                    </div>
    ...
    Harvested from the choicest paddies and milled under strict hygienic standards, our rice 
    brings authentic flavor and nutrition to every meal. Trusted by families, chefs, and culinary 
    businesses alike, we make sure every grain meets your highest expectations.
                        </p>
                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-6">
                            <div class="text-center sm:text-left">
                                <h3 class="text-4xl sm:text-5xl font-bold">99%</h3>
                                <p class="mt-2 text-sm">
                                    Of our customers are satisfied with the freshness, texture, and aroma of our rice.
                                </p>
                            </div>
                            <div class="text-center sm:text-left">
                                <h3 class="text-4xl sm:text-5xl font-bold">100%</h3>
                                <p class="mt-2 text-sm">
                                    Quality-checked and hygienically packaged rice, ready to be delivered to your
                                    doorstep.
                                </p>
                            </div>
            ...
            <div
                class="pt-6 mt-6 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6 px-4 sm:px-8 lg:px-16">
                <div
                    class="relative sm:row-span-2 bg-[#FFF1CB] rounded-lg overflow-hidden flex flex-col p-6 transition duration-300 ease-in-out hover:scale-105 hover:shadow-lg">
                    ...
                    <div>
                        <p class="text-[#383E49] text-lg font-bold mb-4 mt-5 text-center">Rp
                            <?= number_format($dataTransksi, 2, ',', '.'); ?></p>
                    </div>
                </div>
                <div
                    class="relative sm:row-span-2 bg-[#FFF1CB] rounded-lg overflow-hidden flex flex-col p-6 transition duration-300 ease-in-out hover:scale-105 hover:shadow-lg">
                    ...
                    <div>
                        <p class="text-[#383E49] text-lg font-bold mb-4 mt-5 text-center"><?= $dataPesananBeras; ?> Rice
                        </p>
                    </div>
                </div>
                <div
            ...
            <div class="mb-4 mx-6 md:mx-16 mt-8 text-center ">
                <p class="text-3xl sm:text-4xl font-semibold text-[#3D3D3D]">Frequently Asked Questions</p>
                <p class="mt-4 text-lg text-[#666666]">Find quick answers to common questions about our rice products,
                    delivery, and services.</p>
            </div>
            <section class="relative isolate bg-custom mb-4 pt-4">
                <div class="py-6 px-4 sm:px-8 lg:px-16 max-w-6xl mx-auto flex flex-col md:flex-row gap-6">
                    <div class="flex flex-col justify-start items-center text-center md:basis-1/2">

                        <img src="../../assets/gambar/pelanggan/Dashboard2_pelanggan.png" alt="faq"
                            class=" object-cover w-full h-auto max-w-md mx-auto -mt-12 md:-mt-16">
                    </div>
                    <div class="md:basis-1/2">
                        <div class="h-[500px] overflow-hidden">
                            <ul class="basis-full md:basis-1/2">
                                <li class='group relative'>
                                    <button
                                        ...
                                        aria-expanded="false">
                                        <span class="flex-1 text-md font-regular">What types of rice does SimaBer
                                            offer?</span>
                                    ...
                                    <div class="transition-all duration-300 ease-in-out group-hover:max-h-60 max-h-0 overflow-hidden"
                                        ...
                                        <div class="pb-5 leading-relaxed">
                                            <div class="space-y-2 leading-relaxed text-md font-regular text-[#666666]">
                                                We offer a wide variety of rice including premium white rice, <br>
                                                organic rice,
                                                daily rice, organic rice, and specialty regional varieties <br>
                                            </div>
                                        </div>
                                    </div>
                                </li>
                                <li class='group'>
                                    <button
                                        class="relative flex gap-2 items-center w-full py-5 text-base font-semibold text-left border-t md:text-lg border-base-content/10"
                                        aria-expanded="false">
                                        <span class="flex-1 font-regular">Is the rice at SimaBer hygienically
                                            processed?</span>
                                        <svg class="flex-shrink-0 w-4 h-4 ml-auto fill-current" viewBox="0 0 16 16"
                                            xmlns="http://www.w3.org/2000/svg">
                                            <rect y="7" width="16" height="2" rx="1"
                                    ...
                                    <div class="transition-all duration-300 ease-in-out group-hover:max-h-60 max-h-0 overflow-hidden"
                                        ...
                                        <div class="pb-5 leading-relaxed">
                                            <div class="space-y-2 leading-relaxed text-md font-regular text-[#666666]">
                                                Yes, the
                                                rice we sell is hygienically processed. We work directly with <br>
                                                trusted farmers
                                                and ensure the rice is cleaned and packaged properly <br> before
                                                reaching our
                                                customers.</div>
                                        </div>
                                    </div>
                                ...
                                <li class='group'>
                                    ...
                                    <div class="transition-all duration-300 ease-in-out group-hover:max-h-60 max-h-0 overflow-hidden"
                                        ...
                                        <div class="pb-5 leading-relaxed">
                                            <div class="space-y-2 leading-relaxed text-md font-regular text-[#666666]">
                                                Deliveryusually takes 1-2 working days, depending on your location. <br>
                                                We'll
                                                provide tracking info as soon as your order is shipped.</div>
                                        </div>
                                    </div>
                                </li>
                                <li class='group'>
                                    <button
                                        class="relative flex gap-2 items-center w-full py-5 text-base font-semibold text-left border-t md:text-lg border-base-content/10"
                                        aria-expanded="false">
                                        <span class="flex-1 font-regular">Can I order in bulk for business or
                                            events?</span>
                                        <svg class="flex-shrink-0 w-4 h-4 ml-auto fill-current" viewBox="0 0 16 16"
                                            xmlns="http://www.w3.org/2000/svg">
                                            <rect y="7" width="16" height="2" rx="1"
                                    ...
                                    <div class="transition-all duration-300 ease-in-out group-hover:max-h-60 max-h-0 overflow-hidden"
                                        ...
                                        <div class="pb-5 leading-relaxed">
                                            <div class="space-y-2 leading-relaxed text-md font-regular text-[#666666]">
                                                Yes, we accept bulk orders for businesses, events, or community needs.
                                                <br>
                                                Contact our team for special pricing and delivery arrangements tailored
                                                to large
                                                quantities.
                                            </div>
                                        </div>
                                ...
                                <li class='group'>
                                    <button
                                        class="relative flex gap-2 items-center w-full py-5 text-base font-semibold text-left border-t md:text-lg border-base-content/10"
                                        aria-expanded="false">
                                        <span class="flex-1 font-regular">Is SimaBer's rice tested for quality and
                                            safety?</span>
                                        <svg class="flex-shrink-0 w-4 h-4 ml-auto fill-current" viewBox="0 0 16 16"
                                            xmlns="http://www.w3.org/2000/svg">
                                            <rect y="7" width="16" height="2" rx="1"
                                    ...
                                    <div class="transition-all duration-300 ease-in-out group-hover:max-h-60 max-h-0 overflow-hidden"
                                        ...
                                        <div class="pb-5 leading-relaxed">
                                            <div class="space-y-2 leading-relaxed text-md font-regular text-[#666666]">
                                                Absolutely.
                                                Every batch of rice is carefully inspected and tested <br> to ensure it
                                                meets high
                                                standards of hygiene, moisture content, <br> and grain quality. We
                                                follow
                                                strict
